            ...
            <div class="container mx-auto px-4 sm:px-8">
                <div class="py-8">
                    ...
                    <span class="h-full absolute inset-y-0 left-0 flex items-center pl-2">
                        ...
                        <div class="relative">
                            <div
                                    class="appearance-none h-full sm:rounded-l-none border block appearance-none w-full bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        ...
                        <div class="relative">
                            <div
                                ...
                                <a class="text-primary" href="admin/user/invite"><i class="fa-solid fa-plus"></i> Invite
                                    User</a>
                            ...
                            <table class="min-w-full leading-normal">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                            ...
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 w-10 h-10">
                                                    <div class="w-full h-full rounded-full text-[30px]">
                                                        ...
                                                        <div
                                                                class="icon icon-{{ $user->icon_color }}">{{$user->icon}}</div>
                                                    </div>
                                                </div>
                                                <div class="ml-3">
                                                    <p class="text-gray-900 whitespace-no-wrap">
                                                        <a class="link"
                                                           href="/user/{{ $user->id }}/edit"> {{ $user->name }} </a>
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            @include('custom_components.buttons')
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
