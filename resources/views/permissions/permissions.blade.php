                        ...
                        <svg viewBox="0 0 24 24" class="h-4 w-4 fill-current text-gray-500">
                            ...
                            <div class="relative">
                                <div
                                    ...
                                    <a class="text-primary" href="permissions/create"><i class="fa-solid fa-plus"></i> Create New</a>
                            ...
                            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                <table class="min-w-full leading-normal">
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 w-10 h-10">
                                                    <div class="icon icon-blue h-16 w-16 rounded-full object-cover">P</div>
                                    ...
                                    <span
                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <p class="text-gray-900 whitespace-no-wrap">
                                            <form method="post" action="{{ route('permission.delete', $permission->id) }}" class="mt-6 space-y-6">
                                                @csrf
                                                @method('delete')
