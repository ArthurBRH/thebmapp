                                        ...
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 w-10 h-10">
                                                    <div class="icon icon-green h-16 w-16 rounded-full object-cover">R
                                                    </div>

                                                </div>
                                                <div class="ml-3">
                                                    <a class="link"
                                                       href="/roles/{{ $role->id }}/edit"> {{ $role->name }} </a>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        ...
                                        @can('supervisor on')
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                ...
                                                <form method="post" action="{{ route('roles.delete', $role->id) }}">
                                                    @csrf
                                                    @method('delete')
                                                    <div class="supervisor flex items-center gap-4">
                                                        <button class="button supervisor">
